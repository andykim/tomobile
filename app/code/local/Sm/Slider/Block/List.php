...
class Sm_Slider_Block_List extends Mage_Catalog_Block_Product_Abstract
{
	...
	protected function _getItems(){
		...
		foreach( $products as $k => $_product ) {
			// echo "<pre>";var_dump($_product->getThumbBack());
			...
			// if(!empty($_product['thumb_back'] ))
			$item['thumb_back'] = (string)Mage::helper('catalog/image')->init($_product, 'thumb_back')->resize($this->getConfig('product_image_width'), $this->getConfig('product_image_height'));
