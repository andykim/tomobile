...
(function($,undefined){
	...
	$.fn.extend({
		...
		function createArrows(container,opt) {
						...
						container.parent().append('<div style="'+hidden+'" class="tp-leftarrow i-next tparrows '+arst+'"></div>');
						container.parent().append('<div style="'+hidden+'" class="tp-rightarrow i-back tparrows '+arst+'"></div>');
		...
		function setBulPos(container,opt) {
			...
			if (opt.navigationVAlign=="bottom")	 bullets.css({'bottom':'0'});
