#!/bin/bash
            ...
            offset=("+0+0")
                for index in {0..0}
                    ...
                    convert -background none MIFF:- -layers merge +repage /home/admin/domains/tomobile.nl/public_html/magelynx_configurator/cache/colormap/dd18de7e6b393e0db6445535c45487b9.png